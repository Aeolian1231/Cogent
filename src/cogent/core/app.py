...
import cogent
from cogent.core.bus.commands import (
    AgentRunCommand,
    AgentRunResult,
...
from cogent.core.bus.envelope import EventPushEnvelope
from cogent.core.config import CogentConfig, get_config
from cogent.core.events.bus import EventBus
from cogent.core.llm.provider import AnthropicProvider
from cogent.core.logging_setup import setup_logging
...
from cogent.core.runner import AgentRunner
from cogent.core.runs import events_file, new_run_id
from cogent.core.session import SessionManager, SessionStore
from cogent.core.trace.record import TraceRecord
from cogent.core.trace.writer import TraceWriter
from cogent.core.transport.ipc_broadcaster import IpcEventBroadcaster
from cogent.core.transport.socket_server import SocketServer, get_connection_writer
...
class CoreApp:
    def __init__(self) -> None:
        ...
        self._config: CogentConfig | None = None
    ...
    async def _ping_handler(self, params: dict[str, Any]) -> PongResult:
        ...
        return PongResult(
            server_version=cogent.__version__,
    ...
    async def run(self) -> None:
        ...
        logger.info("cogent-core %s listening addr=%s", cogent.__version__, addr)
