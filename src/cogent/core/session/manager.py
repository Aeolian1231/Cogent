...
from cogent.core.bus.envelope import HandlerError
from cogent.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from cogent.core.session.model import Session, SessionMode
from cogent.core.session.store import SessionStore
from cogent.core.skills.loader import SkillLoader
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from cogent.core.bus.commands import SessionCompactResult
